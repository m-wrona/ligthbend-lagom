...
object LigthbendlagomsampleService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The ligthbend-lagom-sample service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the LigthbendlagomsampleService.
  */
trait LigthbendlagomsampleService extends Service {
  ...
  override final def descriptor = {
    import Service._
    // @formatter:off
    named("ligthbend-lagom-sample")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(LigthbendlagomsampleService.TOPIC_NAME, greetingsTopic _)
